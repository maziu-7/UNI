...
public:
  ...
  public:
       ...
       el resultat és el p.i. */
    {
      ...
      if(it_entangled != NULL){
      	if (it_entangled->pitem != &(it_entangled->plist->itemsup)){ 
          it_entangled->pitem = it_entangled->pitem->next;
        }
      }
       ...
       el resultat és el p.i. */
    {
    	...
    	if (pitem != plist->iteminf.next)
      	pitem = pitem->prev;
      if(it_entangled != NULL){
      	if (it_entangled->pitem != it_entangled->plist->iteminf.next){ 
          it_entangled->pitem = it_entangled->pitem->prev;
        }
      }
      return *this;
    }
