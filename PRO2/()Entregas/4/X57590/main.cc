    ...
    while (cin >> command) {
        if (command == "push_back") {
            ...
            *it = x;
            ...
            cin >> x;
			l.insert(it,x);
        } else if (command == "changePlusMove") {
            cin >> s1;
            if (s1 != "it1" and s1 != "it2") die("Error: changePlusMove "+s1);
            typename List<T>::iterator &it=s1=="it1"?it1:it2;
            int x;
            cin >> x;
			l.changePlusMove(it,x);
        } else if (command == "changeMinusMove") {
            cin >> s1;
            if (s1 != "it1" and s1 != "it2") die("Error: changeMinusMove "+s1);
            typename List<T>::iterator &it=s1=="it1"?it1:it2;
            int x;
            cin >> x;
			l.changeMinusMove(it,x);
